...
const dynamodb = new AWS.DynamoDB(),
    ...
    dbTables = fgtAutoscaleAws.AutoScaleCore.dbDefinitions.getTables(RESOURCE_TAG_PREFIX);

fgtAutoscaleAws.initModule();

let logger = fgtAutoscaleAws.logger;
...
async function createTable(schema) {
    ...
    try {
        ...
        await fgtAutoscaleAws.AutoScaleCore.Functions.sleep(3000);
        await fgtAutoscaleAws.AutoScaleCore.Functions.waitFor(promiseEmitter, validator);
...
exports.deleteService = async () => {
    try {
        const platform = new fgtAutoscaleAws.AwsPlatform(),
...
exports.fgtAutoscaleAws = fgtAutoscaleAws;
