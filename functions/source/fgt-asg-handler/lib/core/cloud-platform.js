...
module.exports = class CloudPlatform {
    ...
    /**
     * Submit an election vote for this ip address to become the primary instance.
     * Abstract class method.
    ...
    /**
     *
     * @param {String} routeTableId the route table id provided by the platform
     * @param {Object} route a route object containing neccessary information to update the route.
     * It should contain the 0.0.0.0/0 as destination, and the primary FortiGate as the target.
     */
